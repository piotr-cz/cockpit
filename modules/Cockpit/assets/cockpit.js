                ...
                var selected = [], dialog = UIkit.modal.dialog([
                    '<div>',
                        ...
                        '<div class="uk-modal-footer uk-text-right">',
                            '<button class="uk-button uk-button-primary uk-margin-right uk-button-large uk-hidden js-select-button">'+App.i18n.get('Select')+': <span></span> '+App.i18n.get('item(s)')+'</button>',
